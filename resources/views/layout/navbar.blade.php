        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <div class="sidebar-brand-icon rotate-n-15">
                    <img src="{{ asset('assets/img/LogoTI.png') }}" alt="" style="width: 70px; height: 70px;">
                </div>
            ...
            @auth
                @if (Auth()->user()->level == 'Admin' ||
                    ...
                    {{-- <li class="nav-item">
                        ...
                        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                            ...
                            <div class="bg-white py-2 collapse-inner rounded">
                                ...
                                <a class="collapse-item" href="/tugas_akhirs">Tugas Akhir</a>
                                @auth
                                    @if (Auth()->user()->level == 'Admin' || Auth()->user()->level == 'kaprodi')
                                        <a class="collapse-item" href="/ruangan">Ruangan</a>
                                        <a class="collapse-item" href="/sidang">Sidang</a>
                                    @endif
                                @endauth
                                @auth
                    ...
                    @endauth
                    @auth
                        @if (Auth()->user()->level == 'dosen' || Auth()->user()->level == 'Admin' || Auth()->user()->level == 'kaprodi')
                            <li class="nav-item">
