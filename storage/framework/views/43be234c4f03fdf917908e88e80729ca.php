<?php $__env->startSection('main'); ?>
    <div>
        ...
        <form action="<?php echo e(route('penilaian.store')); ?>" method="POST">
            ...
            <input type="hidden" name="kategori" value="<?php echo e(isset($kategori) ? $kategori : ''); ?>">
            ...
            <div class="form-group">
                ...
                <select name="id_tugasakhir" id="id_tugasakhir" class="form-control">
                    <?php $__currentLoopData = $tugasAkhir; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($ta->id); ?>"><?php echo e($ta->judul); ?></option>
            ...
            <div class="form-group">
                <b><label for="dosen_penguji">Dosen Penguji:</label></b>
...
<?php echo $__env->make('layout.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Kuliah\Kuliah\PBL\pbl_sipenta\resources\views/crud/penilaiancreate.blade.php ENDPATH**/ ?>